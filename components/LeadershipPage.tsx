  ...
  const content = {
    ko: {
      hero: {
        ...
        title: "Meet Our Team",
        description:
          "Visionary leaders combining medical expertise, AI innovation, and strategic excellence to revolutionize cerebrovascular healthcare.",
      },
      leaders: [
        {
          name: "Byungjun Park",
          title: "CEO",
          image: "/images/leadership/leadership_1.png",
          credentials: [
        ...
        },
        {
          name: "Hoon Na, PhD",
          title: "CTO",
          image: "/images/leadership/leadership_2.png",
          credentials: [
        ...
        },
        {
          ...
          title: "CMO",
          image: "/images/leadership/leadership_3.png",
          credentials: [
        ...
        },
        {
          ...
          title: "CMO",
          image: "/images/leadership/leadership_4.png",
          credentials: [
                  ...
                  <div className="p-8">
                    ...
                    <div className="flex items-start gap-6 mb-6">
                      ...
                      <div className="relative flex-shrink-0">
                        <div
                          className={`w-32 h-32 rounded-full overflow-hidden border-2 border-white/10 group-hover:border-white/20 transition-all`}
                        >
                          <ImageWithFallback
                            src={leader.image}
                            alt={leader.name}
                        ...
                        {/* Title Badge */}
                        <div
                          className={`absolute -bottom-3 -right-3 w-14 h-14 rounded-xl bg-gradient-to-br ${gradientColors} flex items-center justify-center shadow-lg`}
                        >
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="bg-gradient-to-r from-purple-900/30 to-cyan-900/30 backdrop-blur-xl rounded-3xl border border-purple-500/30 p-12 text-center">
            ...
            <p className="text-white/70 max-w-3xl mx-auto leading-relaxed mb-8">
              ...
              strategic business development, cutting-edge AI technology, and
              world-class medical expertise in neuroradiology and stroke care.
            </p>
            <div className="grid md:grid-cols-3 gap-6 mt-8">
              <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/10">
                ...
                <p className="text-white/60 text-sm">
                  Business excellence from SK Group leadership
                </p>
              </div>
              <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/10">
                ...
                <p className="text-white/60 text-sm">
                  Deep learning expertise driving next-gen solutions
                </p>
              </div>
              <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/10">
                ...
                <p className="text-white/60 text-sm">
                  Leading professors from top medical institutions
                </p>
              </div>
            </div>
          </div>
