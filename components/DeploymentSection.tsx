...
export default function DeploymentSection({ language }: DeploymentSectionProps) {
  const [activeTab, setActiveTab] = useState('hemorrhage');

  const content = {
    ko: {
      title: '배포를 위한 Hyper Insight Suite',
      subtitle: 'AI 기반 솔루션으로 신속한 성능, 원활한 확장성 및 강력한 보안을 제공합니다. 각 병원의 고유한 요구사항에 맞춰 조정 가능한 기능으로 신뢰할 수 있고 미래 지향적인 솔루션을 제공합니다.',
      tabs: {
        hemorrhage: '뇌출혈',
        infarct: '뇌경색',
        aneurysm: '뇌동맥류',
      ...
      hemorrhage: {
        ...
        description: '비조영 뇌 CT 스캔에서 의심되는 급성 뇌내출혈을 감지하고 국소화하도록 설계된 AI 소프트웨어로, 잠재적인 급성 뇌내출혈에 대해 임상의에게 즉시 경고합니다. 의심스러운 영역을 강조 표시하고 뇌출혈의 존재에 대한 확률 점수를 제공하여 의사의 진단 결정을 지원합니다.',
      ...
      infarct: {
        ...
        description: 'AI 소프트웨어로 비조영 뇌 CT 스캔에서 의심되는 급성 뇌경색을 감지하고 국소화하도록 설계되었으며, 잠재적인 급성 뇌경색에 대해 임상의에게 즉시 경고합니다. 의심스러운 영역을 강조 표시하고 뇌경색의 존재에 대한 확률 점수를 제공하여 의사의 진단 결정을 지원합니다.',
        ctaTitle: '비조영 CT 뇌경색',
      ...
      aneurysm: {
        ...
        description: '뇌 CTA 스캔에서 의심되는 뇌동맥류를 감지하고 국소화하도록 설계된 AI 소프트웨어로, 잠재적인 뇌동맥류에 대해 임상의에게 즉시 경고합니다. 의심스러운 영역을 강조 표시하고 동맥류의 존재에 대한 확률 점수를 제공하여 의사의 진단 결정을 지원합니다.',
        ctaTitle: 'CTA 뇌동맥류',
    ...
    en: {
      ...
      subtitle: 'Our AI-powered solutions deliver rapid performance, seamless scalability and robust security. With adaptable features tailored to each hospital\'s unique requirements, it provides dependable, future-ready solutions',
      tabs: {
      ...
      hemorrhage: {
        ...
        description: 'AI software designed to assist in detecting and localizing suspicious acute intracerebral hemorrhage on non-contrast brain CT scans, instantly alerting clinicians to potential acute intracerebral hemorrhage. It highlights suspicious regions and provides a probability score for the presence of hemorrhage to support physicians\' diagnostic decisions.',
        ctaTitle: 'Non-contrast CT Intracerebral Hemorrhage',
        ctaSubtitle: 'AI clinical diagnostic support for major types of intracerebral hemorrhage',
        clinicalUse: {
      ...
      infarct: {
        ...
        description: 'AI software designed to assist in detecting and localizing suspicious acute cerebral infarction on non-contrast brain CT scans, instantly alerting clinicians to potential acute cerebral infarction. It highlights suspicious regions and provides a probability score for the presence of infarction to support physicians\' diagnostic decisions.',
        ctaTitle: 'Non-contrast CT Brain Infarction',
        ctaSubtitle: 'AI clinical diagnostic support for major types of brain infarction',
        clinicalUse: {
          title: 'Clinical Use Case',
          items: [
      ...
      aneurysm: {
        ...
        description: 'AI software designed to assist in detecting and localizing suspected cerebral aneurysms in brain CTA scans, instantly alerting clinicians to potential cerebral aneurysms. It highlights suspicious regions and provides a probability score for the presence of aneurysm to support physicians\' diagnostic decisions.',
        ctaTitle: 'CTA Brain Aneurysm',
        ctaSubtitle: 'AI clinical diagnostic support for small lesions under 3 mm',
        clinicalUse: {
          title: 'Clinical Use Case',
          items: [
          ...
          {activeTab === 'hemorrhage' && (
            ...
            >
              ...
              <div className="text-center mb-12 max-w-4xl mx-auto">
                <h3 className="text-3xl mb-6 text-white">{t.hemorrhage.title}</h3>
                <p className="text-xl mb-4 text-white/80">{t.hemorrhage.subtitle}</p>
                <p className="text-white/70 leading-relaxed">{t.hemorrhage.description}</p>
              </div>

              {/* CTA Title */}
              <div className="text-center mb-8">
                <h4 className="text-2xl mb-2 text-white">{t.hemorrhage.ctaTitle}</h4>
              ...
              <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto mb-12">
                ...
                <Card className="p-6 bg-[#1a1a2e]/60 backdrop-blur-xl border-2 border-purple-500/20 hover:border-purple-500/60 transition-all">
                  <div className="flex flex-col items-center text-center gap-4">
                    ...
                    <div>
                      <div className="text-sm text-white/60 mb-1">{t.stats.hospitals.label}</div>
                      <div className="text-3xl bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
                        ...
                        <span className="text-base ml-1">{t.stats.hospitals.suffix}</span>
                      </div>
                    </div>
                  </div>
                </Card>
                ...
                <Card className="p-6 bg-[#1a1a2e]/60 backdrop-blur-xl border-2 border-cyan-500/20 hover:border-cyan-500/60 transition-all">
                  <div className="flex flex-col items-center text-center gap-4">
                    ...
                    <div>
                      <div className="text-sm text-white/60 mb-1">{t.stats.accuracy.label}</div>
                      <div className="text-3xl bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">
                        {t.stats.accuracy.number}
                        <span className="text-base">{t.stats.accuracy.suffix}</span>
                      </div>
                    </div>
                  </div>
                </Card>
              ...
              <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                {/* Clinical Use Case */}
                <div>
                  <h5 className="text-xl mb-4 text-white">{t.hemorrhage.clinicalUse.title}</h5>
                  <ul className="space-y-3">
                    {t.hemorrhage.clinicalUse.items.map((item, i) => (
                ...
                {/* How It Works */}
                <div>
                  <h5 className="text-xl mb-4 text-white">{t.hemorrhage.howItWorks.title}</h5>
                  <ul className="space-y-3">
                    {t.hemorrhage.howItWorks.items.map((item, i) => (
                      <li key={i} className="flex items-start gap-3 text-white/70">
          ...
          {activeTab === 'infarct' && (
            ...
            >
              ...
              <div className="text-center mb-12 max-w-4xl mx-auto">
                ...
                <p className="text-white/70 leading-relaxed">{t.infarct.description}</p>
              </div>

              {/* CTA Title */}
              <div className="text-center mb-8">
                <h4 className="text-2xl mb-2 text-white">{t.infarct.ctaTitle}</h4>
              ...
              <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                {/* Clinical Use Case */}
                <div>
                  <h5 className="text-xl mb-4 text-white">{t.infarct.clinicalUse.title}</h5>
                  <ul className="space-y-3">
                ...
                {/* How It Works */}
                <div>
                  <h5 className="text-xl mb-4 text-white">{t.infarct.howItWorks.title}</h5>
                  <ul className="space-y-3">
          ...
          {activeTab === 'aneurysm' && (
            ...
            >
              ...
              <div className="text-center mb-12 max-w-4xl mx-auto">
                ...
                <p className="text-white/70 leading-relaxed">{t.aneurysm.description}</p>
              </div>

              {/* CTA Title */}
              <div className="text-center mb-8">
                <h4 className="text-2xl mb-2 text-white">{t.aneurysm.ctaTitle}</h4>
              ...
              <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                {/* Clinical Use Case */}
                <div>
                  <h5 className="text-xl mb-4 text-white">{t.aneurysm.clinicalUse.title}</h5>
                  <ul className="space-y-3">
                ...
                {/* How It Works */}
                <div>
                  <h5 className="text-xl mb-4 text-white">{t.aneurysm.howItWorks.title}</h5>
                  <ul className="space-y-3">
